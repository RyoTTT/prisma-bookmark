    ...
    <div className="container mx-auto px-6 py-16">
      {props.articles.length > 0 ? (
        ...
        <div className="text-center">
          ...
          <Link href="/articles">
            <text className="group mt-5 inline-flex items-center justify-center overflow-hidden rounded-lg bg-gradient-to-br from-purple-600 to-blue-500 p-0.5 font-medium text-gray-900 hover:text-white focus:ring-4 focus:ring-blue-300 group-hover:from-purple-600 group-hover:to-blue-500 dark:text-white dark:focus:ring-blue-800">
